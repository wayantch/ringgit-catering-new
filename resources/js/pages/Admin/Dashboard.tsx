        ...
        <div className="flex items-center gap-4">
            <svg viewBox="0 0 120 120" className="h-24 w-24 shrink-0">
                ...
                {segments.map((seg, i) => {
                    ...
                    const path = arc(cumAngle, cumAngle + sweep - 1);
                    cumAngle += sweep;
...
function StatCard({
    ...
    return (
        <div
            className={`group relative cursor-default overflow-hidden rounded-2xl p-5 shadow-sm ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${
                accent
        ...
        >
            <div className="flex items-start justify-between">
                <div
                    className={`flex h-9 w-9 items-center justify-center rounded-xl ${accent ? 'bg-white/15' : 'bg-secondary'}`}
                >
                    <Icon
                ...
                <div className="p-4">
                    ...
                    <div className="mb-6 flex items-start justify-between">
                        <div>
                            ...
                            <h1 className="mt-1.5 text-3xl font-bold tracking-tight text-text lg:text-4xl">
                                Dashboard
                            </h1>
                        </div>
                    ...
                    <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3">
                        {/* Revenue 7 Hari */}
                        <div className="group rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg lg:col-span-2">
                        ...
                        <div className="group rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3">
                        {/* Recent Orders Table */}
                        <div className="group overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg lg:col-span-2">
                            <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
                                ...
                                <a
                                    href="/admin/pesanan"
                                    className="rounded-lg px-3 py-1.5 text-xs font-medium text-primary transition hover:bg-secondary"
                                >
                                    Lihat semua →
                                </a>
                            </div>
                        ...
                        <div className="group rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                            ...
                            <p className="mt-0.5 mb-5 text-xs text-slate-400">
                                    ...
                                    <div key={i}>
                                        <div className="mb-1.5 flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[10px] font-bold ${i === 0 ? 'bg-primary text-white' : 'bg-secondary text-slate-500'}`}
                                                >
                                                    {i + 1}
                                                </span>
                                                <span className="text-xs leading-tight font-medium text-text">
                                                    {item.name}
                                                </span>
                                            </div>
                                            <span className="text-xs font-semibold text-primary">
                            ...
                            {/* Quick insight */}
                            <div className="mt-6 rounded-xl bg-secondary px-4 py-3">
